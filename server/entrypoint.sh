...
find /usr/share/nginx/html/static/js -type f -print0 | xargs -0 sed -i s,VAR_APP_API_URL,$REACT_APP_API_URL,g
...
find /usr/share/nginx/html/static/js -type f -print0 | xargs -0 sed -i s,VAR_APP_KEYCLOAK_CLIENT,$REACT_APP_KEYCLOAK_CLIENT,g
find /usr/share/nginx/html/static/js -type f -print0 | xargs -0 sed -i s,VAR_APP_KEYCLOAK_REALM,$REACT_APP_KEYCLOAK_REALM,g
